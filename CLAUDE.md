...
- **5 de 12 productos confirmados como descatalogados o sin SKU equivalente exacto en PcComponentes** (no se ha inventado ningún precio, según norma del proyecto): `dell-s2722qc-analisis` (página 410 Gone, no aparece en la categoría de monitores Dell USB-C 27"), `lg-27un880` (920 resultados para "LG 27UN880", el modelo exacto no aparece — sustituido por la gama 27QN880/27G-series, **descatalogado real, no solo enlace roto**), `keychron-k2-v2` (1.380 resultados para "Keychron K2 V2", solo aparecen K2 HE/Pro/Max — modelo descatalogado), `keychron-v1-analisis` y `keychron-k8-pro-analisis` (ambas páginas de producto con switch Brown y Red dan 410 Gone). Quedan con su precio antiguo sin tocar, a la espera de decidir si se marcan como descatalogados en el propio artículo o se buscan más a fondo
- **2 productos con configuración exacta del artículo ya no vendida** (existen variantes más nuevas, pero a precio distinto — no es lo mismo, no se ha sustituido el precio): `lenovo-thinkpad-e14-gen6-analisis` (Ryzen 7 8845HS / Core Ultra 7 original sustituido por ThinkPad E14 **Gen 7**), `asus-vivobook-15-oled-analisis` (Core i5-13500H/i7-13700H original sustituido por variantes i7-1355U a 949€ o i9-13900H a 1.186,49€ — generación distinta, precio no comparable)
- Artículos pendientes de revisión (>30 días), tras esta pasada: 7 (dell-s2722qc, lg-27un880, keychron-k8-pro, keychron-k2-v2, keychron-v1, asus-vivobook-15-oled-analisis, lenovo-thinkpad-e14-gen6-analisis) — todos por el motivo de catálogo descrito arriba, no por falta de intento de actualización
