...
## Estado del código
- Última revisión: 2026-06-26 (11ª pasada — carrusel de guías personalizado, fix fallback Facebook, 4 correcciones del revisor de código, GROQ_API_KEY en step de carrusel)
...
- **Publicaciones de Facebook manuales preparadas (2026-06-26)**: el usuario publica pegando la URL directamente (sin texto ni imagen adicional — Facebook genera la preview del artículo a partir de og:image/og:title/og:description). Artículos pendientes de publicar manualmente: logitech-k380-analisis (25/06, ya publicado en Instagram), monitor-4k-vs-full-hd-teletrabajo-2026 (28/06), intel-wildcat-lake (30/06), corsair-clipper-pro-mini-60 (02/07)
...
## Estado de precios
- Última revisión de precios: 2026-07-07
...
- Calendario completo hasta 2026-09-22 (36 publicaciones totales, 8 ya publicadas: mejor-raton 14/06, samsung 16/06, hp-probook 18/06, razer-pro-click 23/06, logitech-k380 25/06, monitor-4k-vs-full-hd 28/06, intel-wildcat-lake 30/06, corsair-clipper-pro-mini-60 02/07)
- Próxima publicación pendiente: 2026-07-07 — hp-935-creator-wireless (analisis, ratones, martes)
...
- Última publicación: 2026-06-25 — "Logitech K380: el teclado compacto para los que trabajan desde cualquier sitio" (analisis) — publicado automáticamente vía workflow. Publicación en Instagram correcta (carrusel de 4 slides). Publicación en Facebook bloqueada por el revisor (bug GROQ_API_KEY en step de carrusel que propagaba al revisor — corregido en esta misma sesión). El usuario publicó en Facebook de forma manual. Primera publicación con el bug de redes completamente identificado y documentado
- 2026-06-23 — "Razer Pro Click: el ratón profesional de Razer que olvida los LEDs" (analisis) — publicado automáticamente vía workflow a las 08:44 UTC; deploy disparado solo (vía `workflow_run`, sin push humano de rescate) y completado a los ~3 min. Primera publicación que confirma el fix del bug de deploy funcionando de extremo a extremo sin intervención manual. Confirmado visible en producción (HTTP 200, imagen + thumb + categoría ratones todos OK)
