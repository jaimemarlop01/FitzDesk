...
- [ ] **Publicar carruseles retroactivos en Instagram**: 24 artículos (mayo-junio 2026, anteriores al pipeline) tienen ya sus carruseles generados en develop. 15 de ellos usaron fallback de Groq (rate limit). Opciones: (A) regenerar los 15 con `node instagramImageGenerator.js --slug [slug]` mañana cuando se restablezca el límite y luego publicar con `node socialPublisher.js --slug [slug]`; (B) publicar tal como están si el fallback es aceptable. Los 9 generados con Groq completo están listos para publicar ya: `asus-vivobook-15-oled`, `benq-gw2780`, `dell-s2722qc`, `el-nuevo-surface-ultra-rtx`, `hp-probook-455`, `keychron-k2-v2`, `keychron-k8-pro`, `keychron-v1`, `lenovo-thinkpad-e14-gen6`
...
## Estado del código
- Última revisión: 2026-07-18 (16ª pasada — correcciones de calidad textual sobre artículos publicados; aggregateRating en Review schema; pre-generación de slides de Instagram en borradores)
